...
- [x] 4.2 Update ALL existing engine test files (11 files, 27 constructor calls) — all engine constructors pass `new BoardRepository(db)` or `new BoardRepository(initDb())`
