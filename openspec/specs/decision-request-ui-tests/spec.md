## Purpose
Playwright end-to-end test specifications for the decision form UI features introduced in decision-request-improvements: general notes textarea, submitDecisions routing, and related form behavior.
