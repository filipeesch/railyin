# Spec: workflow-seeding-tests

## Purpose

Unit and integration tests for workflow file discovery, seeding, creation, and deletability guard logic in `src/bun/config/workflows.ts`, ensuring correct behavior across all copy, fallback, collision, and guard branches.
