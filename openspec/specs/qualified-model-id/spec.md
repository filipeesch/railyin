## Purpose
Defines the `QualifiedModelId` value object that encodes the engine-routable model ID format used across DB storage, routing, and display throughout the system.
