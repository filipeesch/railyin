...
Pinia unit-test coverage for the workspace store's `localStorage` persistence behaviour: init-from-storage on initialisation and watch-based write-back when a workspace is selected.
