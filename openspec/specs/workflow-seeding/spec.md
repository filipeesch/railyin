## Purpose
The workflow seeding capability ensures the workspace workflows directory is always populated with at least one workflow on startup, copying from the bundled source without overwriting user customizations.
