## Purpose
Refactor the worktree and git subsystems to use dependency injection, improving testability and separation of concerns. Git operations, project config access, and task git context reads/writes are exposed through injectable interfaces and dedicated classes.
