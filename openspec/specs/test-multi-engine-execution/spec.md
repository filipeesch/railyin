# Spec: test-multi-engine-execution

## Purpose

Specifies end-to-end multi-engine execution behavior — engine routing by qualified model ID, model seeding for new tasks, `listModels` aggregation, and column-transition model seeding.
