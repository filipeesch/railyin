...
Defines the test coverage requirements for the AJV-based tool input validation layer. Covers pure unit tests for `validateToolArgs` and integration tests for the `executeCommonTool` validation gate.
