...
Defines the UX and backend contract for workspace-scoped LSP (Language Server Protocol) configuration, including language detection, setup UI in SetupView, and per-project status indicators.
