## Purpose
The refinement harness SHALL manage git worktrees for each non-mock provider, creating a worktree at a pinned commit before runs, resetting between scenarios, and removing the worktree after all runs complete.
