# Spec: Draft Persistence Test Coverage

## Overview

Requirements for test coverage of draft persistence behavior, ensuring draftStore correctness and E2E draft lifecycle across navigation.
