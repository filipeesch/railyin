...
Defines the requirements for Stryker-based mutation testing for both the backend (`src/bun/`) and frontend (`src/mainview/`) codebases, including configuration files, npm scripts, HTML/JSON reports, and a nightly GitHub Actions workflow.
