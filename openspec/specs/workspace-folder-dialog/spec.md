...
Defines requirements for the native folder picker dialog exposed via `workspace.openFolderDialog`, covering correct foreground behaviour and initial-path pre-selection across platforms (with specific requirements for Windows).
