# Spec: Workspace Switch Tests

## Purpose

Defines correctness requirements for workspace switching behaviour in the frontend: rapid switching convergence, state restoration, new workspace initialization, and WebSocket reconnect recovery.
