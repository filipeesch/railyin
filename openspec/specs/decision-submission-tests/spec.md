## Purpose
Unit-test specifications for the `buildDecisionSubmission` helper — covering Q/A formatting, general notes rendering, hidden instruction content, and NEVER prohibition.
...
If `generalNotes` is provided, it SHALL be appended to `userContent` as `\n\n---\n\nGeneral notes: <value>`.
