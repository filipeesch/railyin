## Purpose
Specifies regression test coverage for `TransitionExecutor`, ensuring that tasks returned from with-prompt transitions reflect the final DB state (not a stale pre-write snapshot).
