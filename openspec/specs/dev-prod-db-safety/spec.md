...
Ensures the development workflow defaults to an in-memory SQLite database to prevent accidental mutation of production data, while providing a clear entry point for developers who need to run against real persistent data.
