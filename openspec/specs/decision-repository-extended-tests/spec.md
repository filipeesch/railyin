## Purpose
Extended unit-test specifications for `DecisionRepository` methods added in the decision-request-improvements feature: `buildContextBlock`, `markDecisionsInjected`, and `getLastInjectedCompactionId`.
