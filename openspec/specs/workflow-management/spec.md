## Purpose
The workflow management capability allows users to view, create, edit, and delete workflow templates for the active workspace directly from the setup screen.
