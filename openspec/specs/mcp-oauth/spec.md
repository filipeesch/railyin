## Purpose
Implements OAuth 2.1 authorization for HTTP-transport MCP servers: discovery, dynamic client registration, the manual authorization flow, token persistence, lazy refresh, and refresh-failure recovery.
## Requirements
