# Spec: workflow-management-tests

## Purpose

Handler-level and smoke tests for the workflow management RPCs (`workflow.list`, `workflow.create`, `workflow.delete`, `workflow.getYaml`), verifying guard enforcement, notification callbacks, and ghost-workflow regression fixes.
