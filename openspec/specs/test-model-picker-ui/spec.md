# Spec: test-model-picker-ui

## Purpose

Specifies the model picker UI behavior when multiple engines are configured — grouping, search, OpenCode model persistence, workspace `allowed_engines` filtering, and engine badge display.
