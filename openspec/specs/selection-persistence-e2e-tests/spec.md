...
Playwright E2E test coverage verifying that workspace and board selections are persisted to `localStorage` and correctly restored after a full page reload, including all stale-key fallback scenarios.
