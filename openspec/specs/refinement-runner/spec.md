## Purpose
The refinement runner is the CLI entry point for executing refinement scenarios. It orchestrates the full measurement cycle: starting the proxy, running scenarios, collecting inspection records and assertion results, writing JSON report files, and optionally comparing against a baseline for regression detection.
