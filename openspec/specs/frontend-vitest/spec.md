# Spec: Frontend Vitest

## Purpose

Defines the requirements for running frontend (`src/mainview/`) tests with Vitest instead of `bun:test`, enabling Stryker-based mutation testing against the Vue/Pinia frontend codebase.
