...
Defines the incremental streaming behaviour of the Claude engine: how `stream_event` messages from the Claude Agent SDK are translated into immediate EngineEvents so that text and reasoning appear in the UI progressively during generation.
