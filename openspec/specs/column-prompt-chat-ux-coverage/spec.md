## Purpose
Defines required automated coverage for the column prompt chat UX, spanning backend integration, frontend helper logic, and Playwright validation of prompted transition cards.
