## Purpose
Refinement scenarios are YAML files that define scripted conversations and assertions for the refinement harness. They drive mock-mode proxy responses and declare measurable expectations about tool usage, cache prefix stability, and token budgets.
