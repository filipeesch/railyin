## Purpose
The refinement harness SHALL support real-codebase scenarios that use the Railyin worktree directly as working directory, enabling testing against the full production codebase rather than fixture files.
