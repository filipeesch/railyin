...
//
// parentBlockId propagation (callStack):
//   tool_call "c1"      → parentBlockId=null  (callStack → ["c1"])
//   tool_call "c2"      → parentBlockId="c1"  (callStack → ["c1","c2"])
//   tool_result "c2"    → parentBlockId="c1"  (pop c2, callStack → ["c1"])
//   tool_result "c1"    → parentBlockId=null  (pop c1, callStack → [])
//   assistant           → parentBlockId=null
//
